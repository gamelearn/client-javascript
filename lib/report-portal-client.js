...
class RPClient {
   ...
   */
            ...
            this.map[tempId] = this.getNewItemObj((resolve, reject) => {
                ...
                this.restClient.create(url, launchData, { headers: this.headers })
                    .then((response) => {
                        ...
                        fs.writeFile('../error_output/launch_uuid', this.launchUuid, function (err) {
                            if (err) throw err;
                        }); 
                        //console.log('launchUuid: ' + this.launchUuid);
    ...
    finishTestItem(itemTempId, finishTestItemRQ) {
        ...
        // console.log('children:', itemObj.children);
    ...
    sendLogWithoutFile(itemTempId, saveLogRQ) {
        ...
        const requestPromise = (itemUuid, launchUuid) => {
            ...
            return this.restClient.create(url, Object.assign(saveLogRQ, { launchUuid }, isItemUuid && { itemUuid }), { headers: this.headers });
        };
